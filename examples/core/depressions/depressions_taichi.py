...
basin_route = pool.get_data(ti.i32, (n_flat,))
b_rcv = pool.get_data(ti.i32, (n_flat,))
...
solver = make_depression_solver(
    ...
    rec_scratch=rec_scratch.data, basin_route=basin_route.data, b_rcv=b_rcv.data, n_flat=n_flat,
)
