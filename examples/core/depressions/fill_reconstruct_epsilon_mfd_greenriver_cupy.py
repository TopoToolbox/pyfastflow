...
reconstruction -> "reconstruct_epsilon" (a parent-hop-distance-scaled
epsilon added on top of `filled`) -> persistent-kernel MFD accumulation on
that surface, on cupy.
