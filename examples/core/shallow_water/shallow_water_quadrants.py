...
rest_depth_p = QuadrantsParameter("REST_DEPTH", dtype=qd.f32, mode="const", value=REST_DEPTH_VAL, pool=pool)
drop_r_p = QuadrantsParameter("DROP_R", dtype=qd.i32, mode="const", value=DROP_R_VAL, pool=pool)
