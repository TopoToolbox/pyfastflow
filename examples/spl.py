...
noise =  dg2.PerlinNoiseF32(frequency=0.1, amplitude=1.0, octaves=6, seed=random.randint(1,32000000))
...
noiseU = dg2.PerlinNoiseF32(frequency=0.02, amplitude=1.0, octaves=3, seed=random.randint(1,32000000))
...
router = pf.flow.FlowRouter(nx, ny, dx, boundary_mode = 'periodic_EW', boundaries = None, lakeflow = True, 
...
im = ax.imshow(router.get_Z(), cmap = 'terrain', vmax = 50.)
