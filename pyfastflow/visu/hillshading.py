...
def hillshade_vectorized(
    ...
    for i in z:
        ...
        hillshade_value = (
            cos_zenith * cos_slope + sin_zenith * sin_slope * cos_azimuth_aspect
        )
...
def hillshade_multidirectional_grid(
    grid, altitude_deg=45.0, z_factor=1.0, azimuths_deg=None
):
    """
    ...
    for azimuth_deg in azimuths_deg:
        ...
        hillshade_vectorized(
            grid.z.field, z_temp.field, zenith_rad, azimuth_rad, z_factor
        )
...
def hillshade_numpy(
    ...
    hillshade_2d(
        elevation_array.astype(np.float32),
        hillshade_array,
        zenith_rad,
        azimuth_rad,
        z_factor,
...
def hillshade_multidirectional_numpy(
    elevation_array,
    altitude_deg=45.0,
    z_factor=1.0,
    dx=1.0,
