...
def build_rand_unit(HelperCls, *, seed_need: Need, hash_u32, backend_mod):
    """
    ...
    return HelperCls().need(seed_n).bind("_HASH", hash_u32).bind("_BK", backend_mod).ingest(_rand_unit_tmpl)
...
def build_receivers(
    ...
    *,
    ...
    if mode == "stochastic":
        rand_unit = build_rand_unit(HelperCls, seed_need=seed_need, hash_u32=hash_u32, backend_mod=backend_mod)
