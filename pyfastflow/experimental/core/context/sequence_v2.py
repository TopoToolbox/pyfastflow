...
host-driven layer above Routine (routine_v2.py) - an ordered list of blocks
...
as everything else in this package. Named `sequence_v2` for the same reason
routine_v2.py is - `sequence.py` already names the pre-1d implementation this
...
compose() accepts a FrozenKernel, a FrozenRoutine (routine_v2.py) or a
...
override `RoutineBuilder.compose()` does (routine_v2.py) - a dict merged over
...
from .routine_v2 import BoundRoutine, FrozenRoutine
